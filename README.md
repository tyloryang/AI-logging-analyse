...
<tr>
<td width="50%" valign="top">
<img src="screenshots/readme-webhook.png" alt="告警与事件示意图" /><br/>
<sub><b>告警与事件</b>——告警聚合、抑制、去重与分组。</sub>
</td>
<td width="50%" valign="top">
<img src="screenshots/readme-webhook2.png" alt="通知流示意图" /><br/>
...
<td width="50%" valign="top">
<img src="screenshots/readme-dashboard-context.png" alt="直接跳转示意图" /><br/>
...
<tr>
<td width="50%" valign="top">
<img src="screenshots/readme-cli-helper.png" alt="CLI 运维助手示意图" /><br/>
<sub><b>CLI 运维助手</b>——在终端里继续同一套分析、巡检和交互流程。</sub>
</td>
<td width="50%" valign="top">
<img src="screenshots/readme-cli.png" alt="CLI 模式示意图" /><br/>
